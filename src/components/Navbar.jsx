                        ...
                        {user ? (
                            <>
                                <div className="flex items-center gap-2 px-2 py-1.5 rounded-full border border-border bg-card text-sm">
                                    ...
                                    <span className="px-2 py-0.5 rounded-full text-[10px] font-medium uppercase bg-secondary-accent/10 border border-secondary-accent/15 text-secondary-accent">FREE</span>
                                </div>
                            ...
                            <>
                                ...
                                <Link to="/register" className="px-5 py-2.5 rounded-xl bg-primary text-white font-semibold text-sm hover:opacity-90 transition-opacity">
                                    Get Started
                                </Link>
                            </>
                        )}
                    ...
                    <div className="px-4 py-3 space-y-1">
                        {user ? (
                            ...
                            <div className="py-2 space-y-2">
                                ...
                                <Link to="/register" onClick={() => setMobileOpen(false)} className="block px-3 py-3 text-sm font-semibold text-center rounded-xl bg-primary text-white hover:opacity-90 transition-opacity">
                                    Get Started
                                </Link>
                            </div>
                        )}
